...
API_ID = int(getenv("29412624"))
API_HASH = getenv("d79282cd9f9499f03080b82edc8ce84e")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("6535760076:AAFqWdztCEke80iv96waJO4UCvJ2p5JUM8U")

# Get your mongo url from cloud.mongodb.com
MONGO_DB_URI = getenv("mongodb+srv://Vishnusoni14@Vishnu14.op5kq.mongodb.net/?retryWrites=true&w=majority", None)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 60))

# Chat id of a group for logging bot's activities
LOG_GROUP_ID = int(getenv("-1002191075932", None))

# Get this value from @MissRose_Bot on Telegram by /id
OWNER_ID = int(getenv("5923034665", None))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Loggroupofbot")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Loggroupofbot")
